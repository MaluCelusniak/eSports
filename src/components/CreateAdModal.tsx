          ...
          <Dialog.Title className='text-white text-3xl font-black'>Publique um anúncio</Dialog.Title>
           ...
           <div className='flex gap-6'>
             <div className='flex flex-col gap-2'>
               ...
               <div className='flex flex-col gap-2 flex-1'>
                <label htmlFor="hoursStart">Qual horário do dia?</label>
                  <div className='grid grid-cold-2 gap-2'>
            ...
            <footer className='mt-4 flex justify-end gap-4'>
             <Dialog.Close className='bg-zinc-500 hover:bg-zinc-600 h-12 px-5 rounded-md font-semibold'>Cancelar</Dialog.Close>
             <button 
             className='bg-violet-500 hover:bg-violet-600 h-12 px-5 flex items-center gap-3 rounded-md font-semibold'
             type='submit'
             >
